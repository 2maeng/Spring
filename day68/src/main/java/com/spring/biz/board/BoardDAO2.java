...
// RowMapper 인터페이스
//	1) 어떤 ResultSet(DB)을 어떤 자바 객체(POJO)와 매핑 해야하는지 강제 해주는 역할
//									-> DB와 매핑되는 자바 객체 == "VO"
//	2) VO를 알아야 하기 때문에 <> 설정 필수
